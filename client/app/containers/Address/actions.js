...
export const fetchAddress = addressId => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/address/${addressId}`);
...
export const addAddress = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/address/add`, address);
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_API_URL}/address/${newAddress._id}`,
        newAddress
      );

...
export const fetchCategory = id => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/category/${id}`);
...
export const updateCategory = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/category/${category._id}`, {
...
export const activateCategory = (id, value) => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/category/${id}/active`, {
        category: {
          isActive: value
        }
      });
...
export const deleteCategory = id => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.delete(`${process.env.REACT_APP_API_URL}/category/delete/${id}`);

...
export const fetchStoreProduct = slug => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/product/item/${slug}`);
...
export const fetchBrandProducts = slug => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/product/list/brand/${slug}`);
...
export const fetchProductsSelect = () => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/product/list/select`);
...
export const addProduct = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/product/add`, formData, {
...
export const updateProduct = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/product/${product._id}`, {
        product: newProduct
      });
...
export const activateProduct = (id, value) => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/product/${id}/active`, {
        product: {
          isActive: value
        }
      });
...
export const deleteProduct = id => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.delete(`${process.env.REACT_APP_API_URL}/product/delete/${id}`);
